...
The Docker containers are based on images created by [Nho Luong](https://hub.docker.com/u/nholu), specifically for Ansible testing (look for images named `geerlingguy/docker-DISTRO-ansible`). You can use any of his images, but only the distributions mentioned in [meta/main.yml](meta/main.yml) are supported.
